function [Mthermal, Tsteps, Maf, muHaf] = PrimaryAndSecondaryRemanenceTRM(V, VBark, HK0, Tc, tau0, N, f, mx, my, T, t, muH0, Tsteps, muHaf)
% Simulates a primary TRM, followed by a perpendicular secondary TRM for
...
% muHaf - AF peak field steps of the AF demagnetization
% (vector) [T]
    ...
    mx = AcquireTRMMD(V, VBark, HK0, Tc, tau0, N, mx, T0, T, t, 0); 
    my = AcquireTRMMD(V, VBark, HK0, Tc, tau0, N, my, T0, T, t, muH0); 
